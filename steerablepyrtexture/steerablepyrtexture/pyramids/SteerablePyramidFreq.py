...
from ..tools.creplace import point_op
...
class SteerablePyramidFreq(SteerablePyramidBase):
    ...
    def __init__(self, image, height='auto', order=3, twidth=1, is_complex=False):
        ...
        lo0mask = point_op(log_rad, YIrcos, Xrcos[0], Xrcos[1]-Xrcos[0])
        ...
        for i in range(self.num_scales):
            ...
            himask = point_op(log_rad_test, Yrcos, Xrcos[0], Xrcos[1]-Xrcos[0])
            ...
            for b in range(self.num_orientations):
                ...
                anglemask = point_op(angle_tmp, Ycosn, Xcosn[0]+np.pi*b/self.num_orientations,
                                    Xcosn[1]-Xcosn[0])
            ...
            lomask = point_op(log_rad_tmp, YIrcos, Xrcos[0], Xrcos[1]-Xrcos[0])
    ...
    def recon_pyr(self, levels='all', bands='all', twidth=1):
        ...
        lomask = point_op(nlog_rad_tmp, YIrcos, Xrcos[0], Xrcos[1]-Xrcos[0])
        ...
        for idx in range(1, len(bound_list)-1):
            ...
            if idx > 1:
                ...
                lomask = point_op(nlog_rad2_tmp, YIrcos, Xrcos[0],
                                 Xrcos[1]-Xrcos[0])
